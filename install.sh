...
show_usage_instructions() {
    ...
    echo "  git-monitor run --verbose    # Run demo mode and validate log output"
    echo "  git-monitor status           # Placeholder status command"
    echo "  git-monitor start            # Placeholder daemon command"
    echo "  git-monitor stop             # Placeholder stop command"
    echo "  git-monitor install          # Service install not implemented yet"
    echo ""
    ...
    echo "  2. Confirm the demo entries appear in your log file"
    echo "  3. Treat service commands as scaffolding until shell integration is implemented"
    echo ""
