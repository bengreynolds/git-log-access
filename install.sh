...
show_usage_instructions() {
    ...
    echo "  git-monitor install          # Install shell hooks and enable interception"
    echo "  git-monitor start            # Enable interception"
    echo "  git-monitor stop             # Disable interception"
    echo "  git-monitor status           # Show hook installation status"
    echo "  git-monitor uninstall        # Remove installed hooks"
    echo ""
    ...
    echo "  1. Run: git-monitor install"
    echo "  2. Restart your shell if needed, then run a git command"
    echo "  3. Confirm entries appear in your configured log file"
    echo ""
